...
const appDirs = ['example/child-react', 'example/child-vue', 'example/parent']

const rootDir = path.resolve(__dirname, '..', '..')

module.exports = async () => {
  console.log('[e2e test]: start building sfmic dist')
  await execa('npm', ['run', 'build'], {
    cwd: rootDir,
    env: process.env
  })
  console.log('[e2e test]: end building sfmic dist')
